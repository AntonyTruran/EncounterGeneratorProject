...
public class EncounterChartRepositoryTests {
	...
	private static final String MOCK_TABLE_ROW = "[{\"id\":0,\"monsterKey\":\"1\",\"biomeKey\":\"URBLL\",\"number\":\"1d4\",\"maxChance\":\"14\",\"minChance\":\"10\"}]";
	private static final String MOCK_ENTRY = "{\"id\":0,\"monsterKey\":\"1\",\"biomeKey\":\"URBLL\",\"number\":\"1d4\",\"maxChance\":\"14\",\"minChance\":\"10\"}";
	...
	@Test
	public void getCreaturesByChart() {
		...
		assertEquals(MOCK_TABLE_ROW, repo.getAllEncounterCharts());
	}
	...
	public void removeEncounterChartValid() {
		...
		assertEquals("{\"message\": \"the biome has been successfully deleted\"}", repo.removeEncounterChart("any"));
	}

	@Test
	public void removeEncounterChartInvalid() {
		assertEquals("{\"message\": \"invalid biome reference\"}", repo.removeEncounterChart("any"));
	}
	...
	public void updateEncounterChartValid() {
		...
		assertEquals("{\"message\": \"the biome has been successfully updated\"}",
				repo.updateEncounterChart("any", updatedEncounterChart));
	...
	public void updateEncounterChartInvalid() {
		String updatedEncounterChart = "{\"biomeId\":0,\"biomeReference\":\"URBLL\",\"biomeName\":\"urban\"}";
		;
		assertEquals("{\"message\": \"invalid biome reference\"}", repo.updateEncounterChart("any", updatedEncounterChart));
	}
}
